...
import { initialState, create_list, delete_list, lists, type ListsState, rename_list, register_pending_share, accept_pending_share } from '$lib/components/lists';
...
describe('lists', () => {
  ...
  it('registers a list share', () => {
    ...
    nextState = lists(nextState, {...register_pending_share({id: "id1", name:"shareMe"}), creator: "god"});
