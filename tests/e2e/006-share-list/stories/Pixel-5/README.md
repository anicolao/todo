...
### Step 009: removal_completed

**Verifications:**
- [x] Recipient processes a removal without pointer movement; sender sees its confirmed outcome

![removal_completed](screenshots/009-removal-completed.png)

### Step 010: invitation_pending

**Verifications:**
- [x] Already-sent invitations are read-only and cannot be duplicated

![invitation_pending](screenshots/010-invitation-pending.png)

### Step 011: shared_deletion

**Verifications:**
- [x] Deleting the list removes it from both participants’ navigation

![shared_deletion](screenshots/011-shared-deletion.png)
